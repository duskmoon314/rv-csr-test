...
pub type HALTED_W<'a, const O: u8> = crate::BitWriter<'a, u32, S2MM_DMASR_SPEC, HALTED_A, O>;
...
pub type SG_INCLD_W<'a, const O: u8> = crate::BitWriter<'a, u32, S2MM_DMASR_SPEC, SG_INCLD_A, O>;
...
pub type IOC_IRQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, S2MM_DMASR_SPEC, IOC_IRQ_A, O>;
...
pub type DLY_IRQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, S2MM_DMASR_SPEC, DLY_IRQ_A, O>;
...
pub type ERR_IRQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, S2MM_DMASR_SPEC, ERR_IRQ_A, O>;
