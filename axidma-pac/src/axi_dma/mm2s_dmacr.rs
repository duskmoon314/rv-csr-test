...
pub type RUN_STOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, MM2S_DMACR_SPEC, RUN_STOP_A, O>;
...
pub type KEYHOLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MM2S_DMACR_SPEC, KEYHOLE_A, O>;
...
pub type IRQ_DELAY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MM2S_DMACR_SPEC, u8, u8, 8, O>;
impl R {
